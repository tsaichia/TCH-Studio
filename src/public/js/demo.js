  ...
  class Menu {
    ...
    openItem (menuItem) {
      ...
      this.openItemTimeline = new TimelineMax({
        ...
        .staggerTo(columnsElems, duration, {
          ease: ease,
          cycle: {
            y: (i, t) => t.classList.contains('column--bottom') ? columns[i].height + winsize.height * 0.2 : -1 * columns[i].height - winsize.height * 0.2
          },
          // scaleX: 0.7,
          opacity: 0
        }, columnsStagger, 0)
        ...
        .staggerTo(menuItem.DOM.letters, duration * 0.7, {
          ease: ease,
          cycle: {
        ...
        .to(this.menuItems.filter(item => item != menuItem).map(t => t.DOM.el), duration * 0.5, {
          ease: ease,
          opacity: 0
        }, 0)
    ...
    closeItem () {
      ...
      this.openItemTimeline = new TimelineMax({
        ...
        .to(this.menuItems[this.currentItem].DOM.letters, duration * 0.6, {
          ease: Quint.easeOut,
          y: 0,
          opacity: 1,
          rotation: 0
        }, duration)
        .to(this.DOM.items, duration * 0.6, {
          ease: ease,
          opacity: 1
        }, duration)
    }
